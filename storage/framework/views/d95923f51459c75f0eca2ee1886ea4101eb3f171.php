                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0 dataTable">
                            ...
                            <?php $__currentLoopData = $journalEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journalEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="Id">
                                        <a href="<?php echo e(route('journal-entry.show',$journalEntry->id)); ?>">
                                            <?php
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onamhamy/public_html/account/resources/views/journalEntry/index.blade.php ENDPATH**/ ?>