                ...
                <div class="col-lg-4 col-md-4">
                 ...
                 <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="form-icon-user">
                            <!--<span><i class="fas fa-joint"></i></span>-->
                            <?php echo e(Form::select('vouchertype', array('JV' => 'Journal Voucher', 'BPV' => 'Bank payment Voucher', 'CPV' => 'Cash payment Voucher', 'BR' => 'Bank Receipt' , 'CR' => 'Cash Receipt'), 'JV', array('class' => 'form-control','required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onamhamy/public_html/account/resources/views/journalEntry/edit.blade.php ENDPATH**/ ?>