    ...
    <div class="scrollbar-inner">
        <div class="div-mega">
            ...
            <ul class="navbar-nav navbar-nav-docs">
                ...
                <?php if( Gate::check('manage chart of account')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')?' active':'collapsed'); ?>" href="#navbar-double-entry" data-toggle="collapse" role="button" aria-expanded="<?php echo e((Request::segment(1) == 'bill' )?'true':'false'); ?>" aria-controls="navbar-double-entry">
                            <i class="fas fa-balance-scale"></i>Master Records (<?php echo e(__('Chart of Accounts')); ?>)
                        ...
                        <div class="collapse <?php echo e((Request::segment(1) == 'chart-of-account'  || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')?'show':''); ?>" id="navbar-double-entry">
                            <ul class="nav flex-column submenu-ul">
                                ...
                                <?php endif; ?>
                                    <li class="nav-item"><a href="#" class="nav-link">Account Creation</a></li>
                                    <li class="nav-item"><a href="#" class="nav-link">Account Edit</a></li>
                                    <li class="nav-item"><a href="#" class="nav-link">Account Delete</a></li>
                                    <li class="nav-item"><a href="#" class="nav-link">Account Active/Inactive</a></li>
                            </ul>
                        </div>
                    </li>
                <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((Request::segment(1) == 'document-entry')?' active':'collapsed'); ?>" href="#navbar-general-ledger" data-toggle="collapse" role="button" aria-expanded="<?php echo e((Request::segment(1) == 'document-entry')?'true':'false'); ?>" aria-controls="navbar-general-ledger">
                            <i class="fas fa-balance-scale"></i>General Ledger
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse" id="navbar-general-ledger">
                            <ul class="nav flex-column submenu-ul">
                                    <li class="nav-item <?php echo e((Request::route()->getName() == 'document-entry.index') ? ' active' : ''); ?>" ><a href="<?php echo e(route('document-entry.index')); ?>" class="nav-link">Document Entry</a></li>
                                    <li class="nav-item"><a href="#" class="nav-link">Document Display</a></li>
                                    <li class="nav-item"><a href="#" class="nav-link">Document Edit</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#navbar-general-receivables" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-general-receivables">
                            <i class="fas fa-money-bill-alt"></i>Receivables
                            <i class="fas fa-sort-up"></i>
                        </a>
                         <div class="collapse" id="navbar-general-receivables">
                            <ul class="nav flex-column submenu-ul">
                                 <?php if( Gate::check('manage invoice') ||  Gate::check('manage revenue') ||  Gate::check('manage credit note')): ?>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e((Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')?' active':'collapsed'); ?>" href="#navbar-income" data-toggle="collapse" role="button" aria-expanded="<?php echo e((Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')?'true':'false'); ?>" aria-controls="navbar-income">
                                            Master Records(Customer Accounts)
                                        ...
                                        <div class="collapse <?php echo e((Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')?'show':''); ?>" id="navbar-income">
                                            <ul class="nav flex-column submenu-ul">
                                                <?php if(Gate::check('manage customer')): ?>
                                                    ...
                                                    <li class="nav-item"><a href="#" class="nav-link">Customer Creation</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Customer Edit</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Customer Delete</a></li>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage invoice')): ?>
                                                    <li class="nav-item <?php echo e((Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show') ? ' active' : ''); ?>">
                                                        <a href="<?php echo e(route('invoice.index')); ?>" class="nav-link">Document entry
                                                            <!--<?php echo e(__('Invoice')); ?>-->
                                                            </a>
                                                    </li>
                                                    <li class="nav-item <?php echo e((Request::route()->getName() == 'invoice.show') ? ' active' : ''); ?>">
                                                        <a href="<?php echo e(route('invoice.index')); ?>" class="nav-link">Document Display
                                                            <!--<?php echo e(__('Invoice')); ?>-->
                                                            </a>
                                                    </li>
                                                    <li class="nav-item <?php echo e((Request::route()->getName() == 'invoice.edit') ? ' active' : ''); ?>">
                                                        <a href="<?php echo e(route('invoice.index')); ?>" class="nav-link">Document Edit
                                                            <!--<?php echo e(__('Invoice')); ?>-->
                                                            </a>
                                                    </li>
                                                <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="#navbar-general-reporting-receivables" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-general-reporting-receivables">
                                        <!--<i class="fas fa-balance-scale"></i>-->
                                        Reporting
                                        <!--<i class="fas fa-sort-up"></i>-->
                                    </a>
                                    <div class="collapse" id="navbar-general-reporting-receivables">
                                        <ul class="nav flex-column submenu-ul">
                                                <li class="nav-item"><a href="#" class="nav-link">Account Balances</a></li>
                                                <li class="nav-item"><a href="#" class="nav-link">Individual Customer Account</a></li>
                                                <li class="nav-item"><a href="#" class="nav-link">Age Analysis</a></li>
                                                <!--<li class="nav-item"><a href="#" class="nav-link">WHT Reports</a></li>-->
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#navbar-general-payables" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-general-payables">
                            <i class="fas fa-balance-scale"></i>Payables
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse" id="navbar-general-payables">
                            <ul class="nav flex-column submenu-ul">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#navbar-general-vendor" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-general-vendor">
                                            Master Records(Vendor Accounts)
                                        </a>
                                        <div class="collapse" id="navbar-general-vendor">
                                            <ul class="nav flex-column submenu-ul">
                                                    <!--<li class="nav-item"><a href="#" class="nav-link">Vendor</a></li>-->
                                                    ...
                                                    <?php endif; ?>
                                                    <li class="nav-item"><a href="#" class="nav-link">Vendor Creation</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Vendor Edit</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Vendor Delete</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Document Entry</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Document Display</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Document Edit</a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#navbar-general-reporting" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-general-reporting">
                                            Reporting
                                        </a>
                                        <div class="collapse" id="navbar-general-reporting">
                                            <ul class="nav flex-column submenu-ul">
                                                    <li class="nav-item"><a href="#" class="nav-link">Account Balances</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Individual Customer Account</a></li>
                                                    <li class="nav-item"><a href="#" class="nav-link">Age Analysis</a></li>
                  ...
                  <?php if(Gate::check('manage assets')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('account-assets.index')); ?>" class="nav-link <?php echo e((Request::segment(1) == 'account-assets')?'active':''); ?>">
                            <i class="fas fa-calculator"></i><?php echo e(__('Assets')); ?> Accounting
                        </a>
                    </li>
                <?php endif; ?>
                <?php if( Gate::check('manage journal entry') ||   Gate::check('balance sheet report') ||  Gate::check('ledger report') ||  Gate::check('trial balance report')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(( Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')?' active':'collapsed'); ?>" href="#navbar-double-entrys" data-toggle="collapse" role="button" aria-expanded="<?php echo e((Request::segment(1) == 'bill' )?'true':'false'); ?>" aria-controls="navbar-double-entrys">
                            <i class="fas fa-balance-scale"></i>
                            Reporting
                            <!--<?php echo e(__('Double Entry')); ?>-->
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse <?php echo e((Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')?'show':''); ?>" id="navbar-double-entrys">
                            <ul class="nav flex-column submenu-ul">
                ...
                <?php endif; ?>
                 <li class="nav-item">
                        <a class="nav-link" href="#navbar-general-panel" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-general-panel">
                            <i class="fas fa-balance-scale"></i>Control Panel
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse" id="navbar-general-panel">
                            <ul class="nav flex-column submenu-ul">
...
<?php /**PATH /home/onamhamy/public_html/account/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>